...
class FindGap():
    ...
    def OdometryCallback(self, odom):
    	...
    	self.turtlebotangle = odom.pose.pose.orientation.z
    ...
    def LaserScanCallback(self, laserscan):
        ...
        rospy.loginfo('Odom Angle: ' + str(self.turtlebotangle) + '   Gap Angle: ' + str(self.gapTheta) + '   Goal Angle: ' + str(self.turtlebotGoalAngle))
